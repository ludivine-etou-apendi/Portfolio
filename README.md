...
**Stack prévue** : pages statiques (HTML / CSS), hébergement via **GitHub Pages**.

Ce dépôt sert de base au code source du portfolio ; les mises à jour se feront au fil de l’avancement du projet.
